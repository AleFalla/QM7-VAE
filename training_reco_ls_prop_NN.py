...
from separate_models import ls_prop_NN
import torch
...
model_ls_prop=ls_prop_NN(latent_size=latent_size,prop_size=len(prop_list))
model_reco=base_VAE(input_dim=input_dim, latent_size=latent_size)

train_losses, val_losses, val_error, last_model_reco, last_model_prop_ls, test_error_1 = TRAIN_reco_ls_prop(model_reco,model_ls_prop,dataset_1, dataset_2, config_num=config_num, folder_name='VAE_ls_to_prop_NN/checkpoints_reco_ls_prop')
